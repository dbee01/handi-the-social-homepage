...
var LANG = {
  ...
  d_noCast: "حمّل بودكاستك هنا",
  d_loadCastFn: "تحميل البودكاست",
  d_newsletterConfigure: "أضف رابط خلاصة النشرة الإخبارية في الإعدادات.",
  d_ready: "جاهز",
  d_ready: "جاهز",
  ...
  s_premiumElements: "عناصر مميزة (خاصة)",
  ...
  h_sports:
        "<strong>⚽ الرياضة</strong><br><br>• يعرض مباريات كرة القدم المباشرة اليوم والاحتمالات.<br>• اختر الدوريات التي تريد متابعتها في <strong>الإعدادات → الرياضة</strong>.<br>• اضغط على صندوق الاحتمالات لفتح موقع المراهنات.",
