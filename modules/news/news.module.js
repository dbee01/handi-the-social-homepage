    ...
    function renderArticle() {
      ...
      view.innerHTML = `
        <div class="news-article" style="margin-bottom:0;padding:16px;border-radius:12px;display:flex;flex-direction:column;gap:12px;text-align:center;">
          <img class="news-image" src="${article.imageUrl || "/images/noimage.svg"}" alt="" style="width:100%;height:var(--media-height);object-fit:${article.imageUrl ? "contain" : "cover"};border-radius:8px;display:block;" onerror="this.onerror=null;this.src='/images/noimage.svg';this.style.objectFit='cover';">
