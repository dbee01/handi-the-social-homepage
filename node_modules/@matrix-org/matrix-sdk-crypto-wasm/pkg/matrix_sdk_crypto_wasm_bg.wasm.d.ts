...
export function __wbg_otheruseridentity_free(a: number, b: number): void;
export function otheruseridentity_isVerified(a: number): number;
export function otheruseridentity_verify(a: number): number;
export function otheruseridentity_requestVerification(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function otheruseridentity_verificationRequestContent(a: number, b: number, c: number, d: number): void;
export function otheruseridentity_masterKey(a: number, b: number): void;
export function otheruseridentity_selfSigningKey(a: number, b: number): void;
export function otheruseridentity_pinCurrentMasterKey(a: number): number;
export function otheruseridentity_identityNeedsUserApproval(a: number): number;
export function otheruseridentity_wasPreviouslyVerified(a: number): number;
export function otheruseridentity_withdrawVerification(a: number): number;
export function otheruseridentity_hasVerificationViolation(a: number): number;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hcbe769e00e5ebecf(a: number, b: number, c: number, d: number): void;
export function _dyn_core__ops__function__Fn__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hf212058ec899b482(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4e74234ac5b2941e(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h64e01684fc6eeed3(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4dc05586963ea262(a: number, b: number): void;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h9a9b3786d2704af2(a: number, b: number, c: number, d: number): void;
